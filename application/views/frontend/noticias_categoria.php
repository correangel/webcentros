				...
				<div class="row" style="margin-bottom: 20px;">
					<div class="col-xs-1">
						<div class="pull-left" style="width: 45px; margin-right: 15px;">
							<div style="background-color: #dd4814; text-transform: uppercase; font-size: 0.725em; line-height: 2em; font-weight: 400; text-align: center; border: 1px solid #dedede; color: #fff; border-radius: 5px; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-bottom-left-radius: 0; -webkit-border-bottom-left-radius: 0; -moz-border-radius-bottomleft: 0; border-bottom-right-radius: 0; -webkit-border-bottom-right-radius: 0; -moz-border-radius-bottomright: 0;"><?php echo strftime("%b %g", strtotime($item->fechapub)); ?></div> 
							<div style="text-align: center; border: 1px solid #dedede; color: #777; font-weight: 600; border-top: none; border-radius: 5px; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-top-left-radius: 0; -webkit-border-top-left-radius: 0; -moz-border-radius-topleft: 0; border-top-right-radius: 0; -webkit-border-top-right-radius: 0; -moz-border-radius-topright: 0;"><?php echo strftime("%e", strtotime($item->fechapub)); ?></div>
						</div>
						
					</div>
					<div class="col-xs-11">
						<section>
						<h4 class="blog-item-title"><?php echo anchor('noticias/' . $item->alias_categoria . '/' . $item->alias, $item->titulo); ?></h4>
							...
							<form method="post" action="">
								<fieldset>
									...
									<div class="form-group">
										<input type="text" class="form-control" name="user" placeholder="DNI/NIE/Pasaporte">
									</div>
									...
									<button type="submit" class="btn btn-primary btn-block" name="acceder">Acceder</button>
